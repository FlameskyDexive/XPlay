...
static string add_st_string = "Add 'See Through' feature";
        ...
        Texture2D t = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/RealToon/Editor/RT_GUI_Img.png", typeof(Texture2D));
...
//}
        ...
        void Check_RE_OL()
        {
            if (ReaLi("//OL_RE", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader"))
            {
                remoout = true;
                REMO_OUTL();
            }
        ...
        void REMO_OUTL()
        {
            if (remoout == true)
            {
                ChanLi("Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "SRPDefaultUnlit" + (char)34 + "}", "Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("Cull [_DoubleSidedOutline]//OL_RCUL", "//Cull [_DoubleSidedOutline]//OL_RCUL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("#ifdef UNITY_COLORSPACE_GAMMA//SSOL", "//#ifdef UNITY_COLORSPACE_GAMMA//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("_OutlineColor=float4(LinearToGamma22(_OutlineColor.rgb),_OutlineColor.a);//SSOL", "//_OutlineColor=float4(LinearToGamma22(_OutlineColor.rgb),_OutlineColor.a);//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#endif//SSOL", "//#endif//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("#if N_F_O_ON//SSOL", "//#if N_F_O_ON//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("float3 SSOLi=(float3)EdgDet(sceneUVs.xy);//SSOL", "//float3 SSOLi=(float3)EdgDet(sceneUVs.xy);//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#if N_F_O_MOTTSO_ON//SSOL", "//#if N_F_O_MOTTSO_ON//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("float3 Init_FO=((RTD_CA*RTD_SON_CHE_1))*lerp((float3)1.0,_OutlineColor.rgb,SSOLi);//SSOL", "//float3 Init_FO=((RTD_CA*RTD_SON_CHE_1))*lerp((float3)1.0,_OutlineColor.rgb,SSOLi);//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#else//SSOL", "//#else//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("float3 Init_FO=lerp((RTD_CA*RTD_SON_CHE_1),_OutlineColor.rgb,SSOLi);//SSOL", "//float3 Init_FO=lerp((RTD_CA*RTD_SON_CHE_1),_OutlineColor.rgb,SSOLi);//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#endif//SSOL", "//#endif//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#else//SSOL", "//#else//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("#endif//SSOL", "//#endif//SSOL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("//OL_NRE", "//OL_RE", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("//SSOL_U", "//SSOL_NU", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                //============================
                //============================

                ChanLi("static bool remoout = true;", "static bool remoout = false;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string remooutstat = " + (char)34 + "Remove Outline" + (char)34 + ";", "static string remooutstat = " + (char)34 + "Add Outline" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");

                AssetDatabase.ImportAsset("Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                AssetDatabase.ImportAsset("Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                Debug.Log("Outline feature removed on RealToon URP shader.");
            }
            else if (remoout == false)
            {
                ChanLi("Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "remove" + (char)34 + "}", "Tags{" + (char)34 + "LightMode" + (char)34 + "=" + (char)34 + "SRPDefaultUnlit" + (char)34 + "}", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("//Cull [_DoubleSidedOutline]//OL_RCUL", "Cull [_DoubleSidedOutline]//OL_RCUL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                ChanLi("//OL_RE", "//OL_NRE", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ...
                ChanLi("static bool remoout = false;", "static bool remoout = true;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string remooutstat = " + (char)34 + "Add Outline" + (char)34 + ";", "static string remooutstat = " + (char)34 + "Remove Outline" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
        ...
        void Check_SSOL_TOL()
        {
            if (ReaLi("//SSOL_U", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader"))
            {
                UseSSOL = true;
                USSOL_OR_TOL();
            }
        ...
        void USSOL_OR_TOL()
        {
            if (UseSSOL == true)
            {
                ...
                ChanLi("//SSOL_NU", "//SSOL_U", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");

                //============================
                //============================

                ChanLi("static bool UseSSOL = true;", "static bool UseSSOL = false;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string OLType = " + (char)34 + "Traditional" + (char)34 + ";", "static string OLType = " + (char)34 + "Screen Space" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string UseSSOLStat = " + (char)34 + "Use Screen Space Outline" + (char)34 + ";", "static string UseSSOLStat = " + (char)34 + "Use Traditional Outline" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
            ...
            else if (UseSSOL == false)
            {
                ...
                ChanLi("static bool UseSSOL = false;", "static bool UseSSOL = true;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string OLType = " + (char)34 + "Screen Space" + (char)34 + ";", "static string OLType = " + (char)34 + "Traditional" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string UseSSOLStat = " + (char)34 + "Use Traditional Outline" + (char)34 + ";", "static string UseSSOLStat = " + (char)34 + "Use Screen Space Outline" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
        ...
        void TWOFORFIVE()
        {
            ...
            {
                ChanLi("static bool twofourfive_target = false;", "static bool twofourfive_target = true;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string twofourfive_target_string = " + (char)34 + "Change shader compilation target to 4.5" + (char)34 + ";", "static string twofourfive_target_string = " + (char)34 + "Change shader compilation target to 2.0" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");

                ChanLi("#pragma target 2.0 //targetol", "#pragma target 4.5 //targetol", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 2.0 //targetfl", "#pragma target 4.5 //targetfl", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 2.0 //targetsc", "#pragma target 4.5 //targetsc", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 2.0 //targetdo", "#pragma target 4.5 //targetdo", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 2.0 //targetdn", "#pragma target 4.5 //targetdn", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 2.0 //targetm", "#pragma target 4.5 //targetm", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ...
            {
                ChanLi("static bool twofourfive_target = true;", "static bool twofourfive_target = false;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string twofourfive_target_string = " + (char)34 + "Change shader compilation target to 2.0" + (char)34 + ";", "static string twofourfive_target_string = " + (char)34 + "Change shader compilation target to 4.5" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");

                ChanLi("#pragma target 4.5 //targetol", "#pragma target 2.0 //targetol", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 4.5 //targetfl", "#pragma target 2.0 //targetfl", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 4.5 //targetsc", "#pragma target 2.0 //targetsc", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 4.5 //targetdo", "#pragma target 2.0 //targetdo", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 4.5 //targetdn", "#pragma target 2.0 //targetdn", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("#pragma target 4.5 //targetm", "#pragma target 2.0 //targetm", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
        ...
        void DOTSLBSCD()
        {
            ...
            ChanLi("static bool dots_lbs_cd = false;", "static bool dots_lbs_cd = true;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
            ChanLi("static string dots_lbs_cd_string = " + (char)34 + "DOTS|HR - Use Compute Deformation" + (char)34 + ";", "static string dots_lbs_cd_string = " + (char)34 + "DOTS|HR - Use Linear Blend Skinning" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_OL", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_OL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_OL", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_OL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_OL", "uint vertexID : SV_VertexID;//DOTS_CompDef_OL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_OL", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_OL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_OL", "//DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_OL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_FL", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_FL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_FL", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_FL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_FL", "uint vertexID : SV_VertexID;//DOTS_CompDef_FL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_FL", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_FL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_FL", "//DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_FL", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_GB", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_GB", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_GB", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_GB", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_GB", "uint vertexID : SV_VertexID;//DOTS_CompDef_GB", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_GB", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_GB", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_GB", "//DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_GB", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_SC", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_SC", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_SC", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_SC", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_SC", "uint vertexID : SV_VertexID;//DOTS_CompDef_SC", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_SC", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_SC", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_SC", "//DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_SC", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_DO", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_DO", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_DO", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_DO", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_DO", "uint vertexID : SV_VertexID;//DOTS_CompDef_DO", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_DO", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_DO", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.position.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_DO", "//DOTS_LiBleSki(input.indices, input.weights, input.position.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_DO", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_DN", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_DN", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_DN", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_DN", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_DN", "uint vertexID : SV_VertexID;//DOTS_CompDef_DN", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_DN", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_DN", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normal.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_DN", "//DOTS_LiBleSki(input.indices, input.weights, input.positionOS.xyz, input.normal.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_DN", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");


            ChanLi("float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_MV", "//float4 weights : BLENDWEIGHTS;//DOTS_LiBleSki_MV", "Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");
            ChanLi("uint4 indices : BLENDINDICES;//DOTS_LiBleSki_MV", "//uint4 indices : BLENDINDICES;//DOTS_LiBleSki_MV", "Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");
            ChanLi("//uint vertexID : SV_VertexID;//DOTS_CompDef_MV", "uint vertexID : SV_VertexID;//DOTS_CompDef_MV", "Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");
            ChanLi("//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_MV", "DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_MV", "Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");
            ChanLi("DOTS_LiBleSki(input.indices, input.weights, input.position.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_MV", "//DOTS_LiBleSki(input.indices, input.weights, input.position.xyz, input.normalOS.xyz, input.tangentOS.xyz, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_LiBleSki_MV", "Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");


            AssetDatabase.ImportAsset("Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            AssetDatabase.ImportAsset("Assets/ThirdParty/RealToon/RealToon Shaders/RealToon Core/URP/Pass/RT_URP_MoVecPas.hlsl");
            AssetDatabase.ImportAsset("Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
            ...
            {
                ChanLi("static bool dots_lbs_cd = true;", "static bool dots_lbs_cd = false;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string dots_lbs_cd_string = " + (char)34 + "DOTS|HR - Use Linear Blend Skinning" + (char)34 + ";", "static string dots_lbs_cd_string = " + (char)34 + "DOTS|HR - Use Compute Deformation" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
        ...
        void ADD_ST()
        {
            if (add_st == true)
            {
                ChanLi("static bool add_st = true;", "static bool add_st = false;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string add_st_string = " + (char)34 + "Add 'See Through' feature" + (char)34 + ";", "static string add_st_string = " + (char)34 + "Remove 'See Through' feature" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");

                ChanLi("/*//O_ST", "//O_ST/*", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("/*//F_ST", "//F_ST/*", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("/*//G_ST", "//G_ST/*", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
                ChanLi("Pass [_OutStenPass]//O_PI", "//Pass [_OutStenPass]//O_PI", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
            ...
            {
                ChanLi("static bool add_st = false;", "static bool add_st = true;", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("static string add_st_string = " + (char)34 + "Remove 'See Through' feature" + (char)34 + ";", "static string add_st_string = " + (char)34 + "Add 'See Through' feature" + (char)34 + ";", "Assets/ThirdParty/RealToon/Editor/RealToonShaderGUI_URP_SRP.cs");
                ChanLi("//Pass [_OutStenPass]//O_PI", "Pass [_OutStenPass]//O_PI", "Assets/ThirdParty/RealToon/RealToon Shaders/Version 5/URP/Default/D_Default_URP.shader");
